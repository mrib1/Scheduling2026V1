...
/**
 * A large palette of distinct, vibrant colors for clients, excluding greys and neutrals.
 */
export const CLIENT_PALETTE = [
  ...
  '#FF7F50', '#6495ED', '#00CED1', '#9400D3', '#FF1493', '#00BFFF',
  '#ADFF2F', '#FF69B4', '#CD5C5C', '#4B0082', '#7CFC00',
  '#F08080', '#90EE90', '#FFB6C1', '#FFA07A', '#20B2AA',
  '#00FF00', '#32CD32', '#FF00FF',
  '#FF4500', '#DA70D6', '#98FB98', '#DB7093',
  '#FFC0CB', '#DDA0DD', '#FF0000', '#4169E1', '#8B4513',
  '#FA8072', '#F4A460', '#2E8B57', '#00FF7F', '#4682B4',
